...
class MDCRipple extends _component2.default {
  ...
  set unbounded(unbounded) {
    const UNBOUNDED = _foundation2.default.cssClasses.UNBOUNDED;
...
class MDCRippleFoundation extends _foundation2.default {
  ...
  init() {
    ...
    const ROOT = _MDCRippleFoundation$.ROOT,
  ...
  animateActivation_() {
    ...
    const VAR_FG_TRANSLATE_START = _MDCRippleFoundation$2.VAR_FG_TRANSLATE_START,
          VAR_FG_TRANSLATE_END = _MDCRippleFoundation$2.VAR_FG_TRANSLATE_END;
    var _MDCRippleFoundation$3 = MDCRippleFoundation.cssClasses;
    const BG_ACTIVE_FILL = _MDCRippleFoundation$3.BG_ACTIVE_FILL,
          FG_DEACTIVATION = _MDCRippleFoundation$3.FG_DEACTIVATION,
          FG_ACTIVATION = _MDCRippleFoundation$3.FG_ACTIVATION;
    const DEACTIVATION_TIMEOUT_MS = MDCRippleFoundation.numbers.DEACTIVATION_TIMEOUT_MS;
    ...
    if (!this.adapter_.isUnbounded()) {
      ...
      const startPoint = _getFgTranslationCoor.startPoint,
  ...
  getFgTranslationCoordinates_() {
    const activationState = this.activationState_;
    const activationEvent = activationState.activationEvent,
  ...
  runDeactivationUXLogicIfReady_() {
    const FG_DEACTIVATION = MDCRippleFoundation.cssClasses.FG_DEACTIVATION;
    var _activationState_ = this.activationState_;
    const hasDeactivationUXRun = _activationState_.hasDeactivationUXRun,
  ...
  rmBoundedActivationClasses_() {
    ...
    const BG_ACTIVE_FILL = _MDCRippleFoundation$4.BG_ACTIVE_FILL,
  ...
  animateDeactivation_(e, { wasActivatedByPointer, wasElementMadeActive }) {
    const BG_FOCUSED = MDCRippleFoundation.cssClasses.BG_FOCUSED;
  ...
  destroy() {
    ...
    const ROOT = _MDCRippleFoundation$5.ROOT,
  ...
  /** @private */
  removeCssVars_() {
    const strings = MDCRippleFoundation.strings;
  ...
  updateLayoutCssVars_() {
    ...
    const VAR_SURFACE_WIDTH = _MDCRippleFoundation$6.VAR_SURFACE_WIDTH,
...
class MDCTextfield extends _base.MDCComponent {
  static attachTo(root) {
    return new MDCTextfield(root);
  }

  initialize(rippleFactory = el => new _ripple.MDCRipple(el)) {
...
class MDCTextfieldFoundation extends _base.MDCFoundation {
  static get cssClasses() {
    return _constants.cssClasses;
  }
  ...
  activateFocus_() {
    ...
    const FOCUSED = _MDCTextfieldFoundati.FOCUSED,
  ...
  showHelptext_() {
    const ARIA_HIDDEN = MDCTextfieldFoundation.strings.ARIA_HIDDEN;
  ...
  deactivateFocus_() {
    ...
    const FOCUSED = _MDCTextfieldFoundati2.FOCUSED,
  ...
  updateHelptextOnDeactivation_(isValid) {
    ...
    const HELPTEXT_PERSISTENT = _MDCTextfieldFoundati3.HELPTEXT_PERSISTENT,
          HELPTEXT_VALIDATION_MSG = _MDCTextfieldFoundati3.HELPTEXT_VALIDATION_MSG;
    const ROLE = MDCTextfieldFoundation.strings.ROLE;
  ...
  setDisabled(disabled) {
    const DISABLED = MDCTextfieldFoundation.cssClasses.DISABLED;
