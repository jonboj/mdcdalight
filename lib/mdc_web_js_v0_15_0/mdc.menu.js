...
var _simple = __webpack_require__(13);
  ...
  getDefaultFoundation() {
    return new _foundation2.default({
      ...
      getYParamsForItemAtIndex: index => {
        var _items$index = this.items[index];
        const top = _items$index.offsetTop,
...
class MDCSimpleMenuFoundation extends _foundation2.default {
  ...
  init() {
    ...
    const ROOT = _MDCSimpleMenuFoundat.ROOT,
  ...
  animationLoop_() {
    ...
    const TRANSITION_DURATION_MS = _MDCSimpleMenuFoundat3.TRANSITION_DURATION_MS,
